# Deliverables — Part 2 (Reinforcement Learning)

Mapped against `Assignment_Guidelines_Fuzzy_and_RL_Part1_Part2.docx`. This assignment implements
and extends Fuzzy Q-Learning (a Q-learning method with a fuzzy rule-base representation), on
CartPole-v1.

| Deliverable | Status | Location / Link |
|---|---|---|
| Codebase (.ipynb, executed and commented) | ✅ Done | `notebooks/FQL_GTA_Study.ipynb` |
| Extended experiments and results | ✅ Done | `Results/` |
| Research paper (UGC journal submission) | ⏳ Manuscript ready; not yet submitted | `Manuscript/FQL-GTA_Final_Manuscript.docx`, `PDF/` — venue selection and submission are pending |
| PowerPoint presentation | ✅ Done | `Supplementary/Presentation_FQL-GTA.pptx` |
...
- **Journal venue selection and submission** — a judgment call plus the author's own submission-portal account.
